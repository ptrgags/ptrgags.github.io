...
export const boo: MusicAlbumDescriptor = {
  ...
  tracks: [
    ...
    },
    {
      ...
      date: '2020-10-24',
      description:
        'Novation Circuit. Bassline is routed through Korg Monologue. I started this one by solving a sudoku puzzle and using the numbers to pick notes. The fact that this is track 9 is not a coincidence',
    },
    {
    ...
    },
    {
      ...
      date: '2020-10-23',
      description: 'Roland System-1 experimenting with the noise channel',
    },
    {
      ...
      date: '2020-10-11',
      description:
        'Waveform Pro. Various plugins. Trying out 12-tone composition technique. This is also why this is track 12',
    },
    {
      filename: '13_2020-10-21_13MinutesOfSpooky.flac',
      title: '13 minutes of spooky',
      date: '2020-10-21',
      description: 'Experiments with a Roland System-1',
    },
    {
