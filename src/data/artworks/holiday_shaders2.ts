...
export const holiday_shaders2_artworks: ArtworkDescriptor[] = [
  {
    id: '2024-11-21_Toast',
  ...
  },
  {
    ...
    date: '2024-11-21',
    timeline_desc:
      'Fractal Brownian motion image generated from the input text <kbd>Blueberry</kbd>.',
    description: `
        <p>
