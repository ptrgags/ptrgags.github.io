...
const PROJECT_DESCRIPTORS: ProjectDescriptor[] = [
    ...
    },
    {
        ...
        img_format: "png",
        alt_text: "A digital drawing of a scroll with the text 'Eloquent' written in cursive. The letters 'Elo' are colored in red, but the rest of the drawing is in dark yellow.",
        description: `
        <p>
